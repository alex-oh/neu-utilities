...
INSERT INTO `building` VALUES (1,'Building A',100,12,1,2850,2775,4390),(2,'Building B',150,10,1,2810,2446,4740),(3,'Building C',200,14,2,2785,2507,4630),(4,'Building D',100,12,3,2595,2518,4190),(5,'Building E',150,10,4,150,50,300),(6,'Building F',200,14,4,0,0,0),(7,'Building G',120,12,1,240,80,560),(8,'Building H',180,10,2,0,0,0),(9,'Building I',220,14,3,280,84,580),(10,'Building J',110,12,4,0,0,0),(11,'Building K',160,10,1,0,0,0),(12,'Building L',230,14,2,100,30,250),(13,'Building M',130,12,3,110,33,260),(14,'Building N',170,10,4,0,0,0),(15,'Building O',240,14,1,260,70,540),(16,'Building P',140,12,2,0,0,0),(17,'Building Q',190,10,3,0,0,0),(18,'Building R',250,14,4,200,60,400),(19,'Building S',150,12,1,195,59,390),(20,'Building T',200,10,2,340,100,620),(21,'Building U',45,6,1,0,0,0),(22,'Building X',150,12,1,320,90,640),(23,'Building W',150,12,1,0,0,0);
...
INSERT INTO `department` VALUES (1,'Mathematics'),(2,'Computer Science'),(3,'Physics'),(4,'Chemistry'),(5,'Biology'),(6,'History'),(7,'English'),(8,'Psychology'),(9,'Economics'),(10,'Sociology');
...
INSERT INTO `has_space` VALUES (1,1),(1,2),(1,3),(2,4),(2,5),(2,6),(3,7),(3,8),(3,9),(4,10),(4,11),(4,12),(5,13),(5,14),(5,15),(1,16),(1,17),(1,18),(2,19),(2,20),(2,21),(1,22),(1,23);
...
INSERT INTO `maintains` VALUES (21,1),(3,2),(15,3),(10,4),(9,5),(9,6),(22,6),(1,7),(20,8),(6,9),(4,10),(20,10),(7,11),(21,12),(15,13),(13,14),(19,15),(1,16),(2,17),(12,18),(19,19),(8,20),(7,21),(18,22),(4,23),(22,24),(3,25),(5,26),(12,27),(18,28);
...
INSERT INTO `maintenance_task` VALUES (1,'Replace light bulbs in hallway','2024-04-17',1,0,1),(2,'Fix leaking faucet in restroom','2024-04-18',1,0,2),(3,'Repair broken window in office','2024-04-19',1,0,3),(4,'Unclog drain in kitchen','2024-04-17',2,0,4),(5,'Paint conference room walls','2024-04-18',2,0,5),(6,'Replace HVAC filter','2024-04-19',2,0,6),(7,'Clean carpets in lobby','2024-04-17',3,0,7),(8,'Fix broken chair in waiting area','2024-04-18',3,0,8),(9,'Install new security cameras','2024-04-19',3,0,9),(10,'Replace damaged floor tiles','2024-04-17',4,0,10),(11,'Fix electrical outlet in break room','2024-04-18',4,0,11),(12,'Repair roof leak','2024-04-19',4,0,12),(13,'Clean gutters','2024-04-17',5,0,13),(14,'Replace landscaping','2024-04-18',5,0,14),(15,'Repair fence','2024-04-19',5,0,15),(16,'Paint exterior walls','2024-04-17',1,0,16),(17,'Fix broken lock on entrance door','2024-04-18',1,0,17),(18,'Replace carpet in office','2024-04-19',1,0,18),(19,'Install new shelving units','2024-04-17',2,0,19),(20,'Repair HVAC system','2024-04-18',2,0,20),(21,'Replace ceiling tiles','2024-04-19',2,0,21),(22,'Fix broken window in lobby','2024-04-17',3,0,22),(23,'Install new lighting fixtures','2024-04-18',3,0,23),(24,'Paint exterior doors','2024-04-19',3,0,24),(25,'Replace damaged sidewalk','2024-04-17',4,0,25),(26,'Fix plumbing issue in restroom','2024-04-18',4,0,26),(27,'Repair elevator','2024-04-19',4,0,27),(28,'Clean graffiti off walls','2024-04-17',5,0,28),(29,'Replace damaged signage','2024-04-18',5,0,20),(30,'Fix broken sprinkler system','2024-04-19',5,0,10);
...
BEGIN
    ...
    SELECT b.*, 
       ...
       (SELECT GROUP_CONCAT(CONCAT(w.first_name, ' ', w.last_name) SEPARATOR ', ')
        FROM maintains m
        JOIN worker w ON m.employee_id = w.worker_id
        WHERE m.building_id = b.building_id) AS maintenance_workers
FROM building b
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertBuilding`(p_building_name VARCHAR(64), p_max_occupancy INT, p_hours_open INT,
    p_campus_id INT, p_dept_id INT)
BEGIN
    ...
    -- check if the campus exists in the database
    ...
    -- if the campus or department does not exist, do not allow the user to add the building
    ...
    IF dept_exists = 0 THEN
        SIGNAL SQLSTATE '45000'
            SET MESSAGE_TEXT = 'Please use an existing department';
    END IF;
    
    -- insert the building into the building table if the user provides a valid campus and department
    INSERT INTO building (building_name, max_occupancy, hours_open, campus_id)
    VALUES (p_building_name, p_max_occupancy, p_hours_open, p_campus_id);
    
    -- get the auto-generated building_id
    SET new_building_id = LAST_INSERT_ID();
    
    -- insert the department and building relationship into the has_space table
    INSERT INTO has_space (dept_id, building_id)
    VALUES (p_dept_id, new_building_id);
...
-- Dump completed on 2024-04-18 15:55:27
